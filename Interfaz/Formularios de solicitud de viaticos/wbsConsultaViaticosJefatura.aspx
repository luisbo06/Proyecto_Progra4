<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wbsConsultaViaticosJefatura.aspx.cs" Inherits="Control_de_viaticos.Formularios_de_solicitud_de_viaticos.wbsConsultaViaticosJefatura" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td colspan="3"><asp:Button ID="btnVolver" runat="server" Text="Volver" Height="34px" Width="77px" OnClick="btnVolver_Click" />
                    <h1 align="center"> Consultar solicitud de viaticos</h1>
               </td>
           </tr>
            <tr>
                <td colspan="3">
